        ...
        <div class="container-wrap">
            ...
            <aside id="colorlib-aside" role="complementary" class="border js-fullheight">
                <div class="text-center">
                    ...
                    <h1 id="colorlib-logo"><a href="index.html">Andi Muhammad Riffal</a></h1>
                    <span class="position"><a href="#">IT Support/Web Dev/Computer Engineering/IoT</a> in Padang,
                        West Sumatra Barat</span>
                </div>
            ...
            <div id="colorlib-main">
                <section id="colorlib-hero" class="js-fullheight" data-section="home">
                    <div class="flexslider js-fullheight">
                        <ul class="slides">
                            <li
                                style="background-image: url(images/img_bg_1.png); background-size: cover; background-position: center; height: 100vh;">
                                <<div class="overlay"
                                    style="background-color: rgba(255, 255, 255, 0.7); position: absolute; top: 0; left: 0; width: 100%; height: 100%;">
                    </div>
                    ...
                    <li
                        style="background-image: url(images/img_bg_2.png); background-size: cover; background-position: center; height: 100vh;">
                        <<div class="overlay"
                            style="background-color: rgba(255, 255, 255, 0.7); position: absolute; top: 0; left: 0; width: 100%; height: 100%;">
            </div>
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6 col-md-offset-3 col-md-pull-3 col-sm-12 col-xs-12 js-fullheight slider-text">
                        <div class="slider-text-inner">
                            <div class="desc">
                                <h1>Engineering Solutions, Empowering Innovation</h1>
                        ...
                        <div class="row row-bottom-padded-sm animate-box" data-animate-effect="fadeInLeft">
                            <div class="col-md-12">
                                <div class="about-desc">
                                    ...
                                    <p><strong>Hay! Saya Riffal</strong></p>
                                    <p>"Saya adalah seorang lulusan Teknik Komputer dengan pengalaman lebih dari dua
                                        tahun dalam pengembangan web menggunakan framework Laravel dan pengoperasian AWS
                                        Cloud EC2 untuk web server. Saya memiliki minat yang kuat di bidang Web
                                        Programming dan IT Support, dan saya pernah berkompetisi dalam perlombaan IoT
                                        tingkat nasional. Selain itu, saya juga berkemampuan dalam melakukan perbaikan
                                        komputer dan memberikan solusi terkait masalah teknis kepada klien. Dengan
                                        kombinasi keterampilan teknis dan pengalaman praktis, saya selalu bersemangat
                                        untuk terus berkembang dan memberikan kontribusi dalam proyek-proyek teknologi
                                        yang menantang."</p>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="panel-heading" role="tab" id="headingOne">
                                        <h4 class="panel-title">
                                            <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne"
                                                aria-expanded="true" aria-controls="collapseOne">Master Degree Graphic
                                                Design
                                            </a>
                                        </h4>
                                    </div>
                ...
                <div class="row row-bottom-padded-sm animate-box" data-animate-effect="fadeInLeft">
                    <div class="col-md-12">
                        <p class="work-menu"><span><a href="#" class="active">Graphic Design</a></span>
                            <span><a href="#">Web Design</a></span> <span><a href="#">Software</a></span>
